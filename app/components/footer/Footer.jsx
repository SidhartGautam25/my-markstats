        ...
        <div className={styles.footermain}>
            ...
            <div className={styles.footfirst}>
                ...
                <div className={styles.sociallink}>
                    <div className={styles.socialitem}><FaInstagram/></div>
                    <div className={styles.socialitem}><FaLinkedin/></div>
                    <div className={styles.socialitem}><FaTwitter/></div>
                </div>
            ...
            <div className={styles.footsecond}>
                ...
                <div className={styles.footeritem}>&#10148; &nbsp;  terms & Conditions</div>
            ...
            <div className={styles.footthird}>
                ...
                <div className={styles.footeritem}> &#10148; &nbsp;Research Methodology</div>
